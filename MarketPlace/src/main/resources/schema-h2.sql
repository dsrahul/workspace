...
CREATE TABLE TOFFER (ID SERIAL, TITLE VARCHAR(20), DESCRIPTION VARCHAR(255), TYPE_ID BIGINT, CATEGORY_ID BIGINT, MERCHANT_ID BIGINT NOT NULL, VALID_FROM DATE, VALID_TO DATE, DELETED CHAR);
--Offer's Table
