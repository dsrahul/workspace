...
CREATE TABLE TOFFER (ID SERIAL, TITLE VARCHAR(50), DESCRIPTION VARCHAR(1000), TYPE_ID BIGINT, CATEGORY_ID BIGINT, MERCHANT_ID BIGINT NOT NULL, VALID_FROM DATE, VALID_TO DATE, DELETED CHAR);
--Offer's Table
